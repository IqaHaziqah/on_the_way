...
#for windows
mydata = scipy.io.loadmat('..\\MNIST_data\\UCI\\segment-challenge.mat')
#for linux
#mydata = scipy.io.loadmat('../MNIST_data/UCI/ionosphere.mat')
data = np.array(mydata['data'])
label = (mydata['label'])#np.transpose
...
#    'initial':3
#        }
para_o = pd.read_pickle('segment-challenge.txt')
...
#para_o['batch_size']=10
#
#result,generation = generate(10,data,label,para_o)
#
#get_resultC(10,result,generation)
#for value in e:
    
#para_o['batch_size']=15
#para_o['initial']=2
#para_o['norm']=False
result,generation_1,generation_2,generation_3 = generate(10,data,label,para_o)
#get_resultNN(10,result,generation_1)
#get_resultNN(10,result,generation_2)
#get_resultNN(10,result,generation_3)
#para_o['batch_size']=50
#para_o['initial']=4
#para_o['norm']=False
#result,generation_1,generation_2,generation_3 = generate(10,data,label,para_o)
get_resultNB(10,result,generation_1)
get_resultNB(10,result,generation_2)
get_resultNB(10,result,generation_3)

#para_o['batch_size']=10
#para_o['norm']=False
#para_o['initial']=5
#result,generation_1,generation_2,generation_3 = generate(10,data,label,para_o)
#get_resultC(10,result,generation_1)
#get_resultC(10,result,generation_2)
#get_resultC(10,result,generation_3)

#para_o['batch_size']=15
#result,generation = generate(10,data,label,para_o)
#get_resultNN(10,result,generation)
#    
