...
class CVAE(object):
    ...
    def encoder(self,x,reuse=tf.AUTO_REUSE):
        with tf.variable_scope("encoder", reuse=reuse):
            ...
            gaussian_params = self.linear(net, shape=[self.hidden1+1,2 * self.z_dim], scope='en_fc2')
    ...
    def classifier(self,x,name,reuse=tf.AUTO_REUSE):
    ...
    def build_model(self):
        ...
        #classifier
        self.y_pred = self.classifier(x=self.image,name='classifier1')
