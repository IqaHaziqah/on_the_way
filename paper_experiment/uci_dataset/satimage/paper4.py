...
#data=np.loadtxt('../MNIST_data/UCI/satimage.txt',dtype='float32')
#for windows
mydata = scipy.io.loadmat('..\\MNIST_data\\UCI\\satimage.mat')
#for linux
...
#    pickle.dump(generation,f,0)
#f.close()
get_result(N,result,generation,'satimage',False)
#gF1 = []
#ggmean = []
#gauc = []
#for i in range(N):
